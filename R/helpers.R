...
#' transform_xy: Quick transform of spatial objects to WGS84; useful for Leaflet mapping
#'
...
#' quantile_labels: create nice-looking quantile labels for Leaflet mapping
#'
